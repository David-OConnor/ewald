...
use crate::{PmeRecip, fft::make_plan};
...
// todo: Now that you removed cuFFT context, consider consolidating this with your cuFFT FFI wrappers.
unsafe extern "C" {
    // plan lifecycle
    // pub fn make_plan(
    //     // ctx: *mut c_void,
...
//         self.gpu_data.as_ref().unwrap().planner_gpu
//     }
// }
...
//
//     // unsafe { make_plan(ctx.handle, nx, ny, nz, raw_stream) }
